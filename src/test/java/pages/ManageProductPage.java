...
public class ManageProductPage {
    ...
    public void clickmanageProduct() {
    	...
    	TestBase.waitvisibility(DriverManager.getDriver(), manageProductObjects.mangeproducticon);
    ...
    public void Productdetails() {
    	...
    	TestBase.waitfortitle(DriverManager.getDriver(), "Medicare - Product Management");
